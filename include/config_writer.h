...
typedef struct {
    ...
    char no_update_placeholder[33];
    char qmenubar_object_name_placeholder[33];
} config_writer_t;
...
int config_writer_set_no_auto_update(config_writer_t*,int);
int config_writer_set_qmenubar_name(config_writer_t*,const char*);
